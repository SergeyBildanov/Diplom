    ...
    <section class="login">
      ...
      <div class="login__wrapper">
        ...
        @csrf
            ...
            Name
            <input class="login__input" type="name" placeholder="" name="name" required>
          </label>
          ...
          <label class="login__label" for="confirm_password">
            Подтвердите пароль
            <input class="login__input" type="password" placeholder="" name="confirm_password" required>
          </label>
